...
| ⚙️ **تب تنظیمات** | Settings tab | متمرکزسازی تنظیمات (ذخیره‌سازی، سرعت، اعلان، ابزارها) |
...
4. **در تب «⚙️ تنظیمات»** مسیر ذخیره، تعداد تلاش مجدد، محدودیت سرعت، اعلان‌ها و بررسی به‌روزرسانی را تنظیم کنید.
